...
public class Login extends javax.swing.JFrame {
    ...
    private void checkLogin() {
        if (jTextField1.getText().matches(emailPattern) && !jPasswordField1.getText().isBlank()) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "LOGIN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Historic", 1, 18))); // NOI18N
        ...
        try {
            ...
            if (rs.next()) {
                if (rs.getString("role").equals("Admin")) {
                    new adminHome(mail).setVisible(true);
                    dispose();
                } else if (rs.getString("status").equals("inactive")) {
                    //ImageIcon icon = new ImageIcon("src\\image\\wait.png");
                    JOptionPane.showMessageDialog(null, "<html><b style=\"font-size:12px;\">wait for admin's approval</b></html>", "Message", JOptionPane.INFORMATION_MESSAGE);
                    jTextField1.setText("");
                    jPasswordField1.setText("");
                } else {
                    new sellMedicine(mail).setVisible(true);
                    dispose();
                }
            } else {
                //ImageIcon icon = new ImageIcon("src\\image\\Incorrect Password.png");
                JOptionPane.showMessageDialog(null, "<html><b style=\"font-size:12px;color:red;\">Incorrect email <br> or password</b></html>", "Invalid Login Credentials", JOptionPane.ERROR_MESSAGE);
                jTextField1.setText("");
                jPasswordField1.setText("");
            }
